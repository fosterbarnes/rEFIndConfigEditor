...
#define AppDisplayName "rEFInd Config Editor (x64)"
#ifndef AppVersion
...
OutputDir=Output
OutputBaseFilename=rEFIndConfigEditor-x64-installer
...
[Messages]
SetupWindowTitle=rEFInd Config Editor v{#AppVersion} installer (x64)
