...
public sealed class SubmenuEntry
{
    public string Title { get; set; } = "";
    public Dictionary<string, StanzaValue> Fields { get; } = new(StringComparer.OrdinalIgnoreCase);
    public List<string> Trailers { get; } = [];
...
public static class StanzaFieldHelper
{
    public static void SetMultiAwareField(Dictionary<string, StanzaValue> fields, string key, string value)
    {
...
public sealed class StanzaValue
{
...
public sealed class RawConfigRow(string text) : ConfigRow
{
    public string Text { get; } = text;
}

public sealed class GlobalOptionRow(GlobalOption option) : ConfigRow
{
    public GlobalOption Option { get; } = option;
}

public sealed class MenuEntryRow(MenuEntry entry) : ConfigRow
{
    public MenuEntry Entry { get; } = entry;
}

public sealed class RefindDocument
{
